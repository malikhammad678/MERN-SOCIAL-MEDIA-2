    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
       <div className='max-w-6xl mx-auto p-6 '>
        ...
        <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <button disabled={loading}  onClick={() => toast.promise(handleSubmit(),{ loading:'uploading', success: <p>Post Added</p>, error: <p>Post not Added</p> }) }  className='text-sm px-8 py-2 rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800  active:scale-95 transition text-white font-medium cursor-pointer'>
              Publish Post
            </button>
        </div>
